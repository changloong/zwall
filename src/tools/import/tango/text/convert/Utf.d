...
char[]  toString (char[] src, char[] dst, size_t* ate=null) {return src;}
wchar[] toString (wchar[] src, wchar[] dst, size_t* ate=null) {return src;}
dchar[] toString (dchar[] src, dchar[] dst, size_t* ate=null) {return src;}
...
char[] toString (wchar[] input, char[] output=null, size_t* ate=null)
{
        if (ate)
            *ate = input.length;
        else
...
wchar[] toString16 (char[] input, wchar[] output=null, size_t* ate=null)
{
        int     produced;
        char*   pIn = input.ptr;
...
char[] toString (dchar[] input, char[] output=null, size_t* ate=null)
{
        if (ate)
            *ate = input.length;
        else
...
dchar[] toString32 (char[] input, dchar[] output=null, size_t* ate=null)
{
        int     produced;
        char*   pIn = input.ptr;
        char*   pMax = pIn + input.length;
...
wchar[] toString16 (dchar[] input, wchar[] output=null, size_t* ate=null)
{
        if (ate)
            *ate = input.length;
        else
...
dchar[] toString32 (wchar[] input, dchar[] output=null, size_t* ate=null)
{
        int     produced;
        wchar*  pIn = input.ptr;
...
dchar decode (char[] src, ref size_t ate)
{
        dchar[1] ret;
...
dchar decode (wchar[] src, ref size_t ate)
{
        dchar[1] ret;
        return toString32 (src, ret, &ate)[0];
}
